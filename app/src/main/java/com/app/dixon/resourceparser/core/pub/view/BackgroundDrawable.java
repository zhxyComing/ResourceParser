...
public class BackgroundDrawable extends ShapeDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (leftPercent > 0 && rightPercent > 0 && leftPercent < 100 && rightPercent < 100) {
            ...
            StaticLayout layout = new StaticLayout("参数错误", textPaint, r.right,
    ...
    public interface IShapeDrawableBuilder {
        IShapeDrawableBuilder left(int percent);

        IShapeDrawableBuilder right(int percent);

        IShapeDrawableBuilder topColor(int topColor);

        IShapeDrawableBuilder bottomColor(int bottomColor);
